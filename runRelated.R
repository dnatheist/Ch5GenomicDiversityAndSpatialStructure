...
save(output,file = paste(c("output",main), collapse=" "))# save these files for on.

write.table(output$relatedness, main, sep=",", col.names = TRUE, row.names = TRUE) #capture related data in files,for the use of.
